...
| `v2.0.0` | `f63cb11` | 第二轮交付：底部 Dock、设置面板、Win11 系统磨砂材质、单实例保护。255 条测试 |
| `v2.1.0` | `4b1baf5` | 外观按腾讯桌面整理＋Nexus 官方返工：Dock 悬停放大与玻璃承托条、图标名称两行不裁字。270 条测试 |

> 回退时按标签走即可；`v2.1.0` 是最新的外观版本。
